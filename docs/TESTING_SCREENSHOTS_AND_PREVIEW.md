...
| **Streaming / Agent View not working** | The stream targets your **dev server** (e.g. http://localhost:5173), not VS Code (port 8080). Ask the agent to "Start the dev server on port 5173, then start streaming your view."                                                                                                                      |
